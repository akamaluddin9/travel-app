                        ...
                        <div class="card card-details">
                            ...
                            <div class="gallery">
                                <div class="xzoom-container">
                                    <img src="{{ Storage::url($item->galleries->first()->image) }}" object-fit="cover" class="xzoom" id="xzoom-default"
                    ...
                    <div class="col-lg-4">
                        <div class="card card-details card-right">
                            ...
                            <div class="members my-2">
                                <img src="{{ url('frontend/images/members.png') }}" class="member-image" alt="">
